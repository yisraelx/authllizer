...
module.exports = {
   ...
   */
  includePaths: [
    resolvePackagePath('ionic-angular', 'themes'),
    resolvePackagePath('ionicons', 'dist/scss'),
    resolvePackagePath('ionic-angular', 'fonts'),
    resolvePackagePath('font-awesome', 'scss')
  ],
